...
const userAuth: FeatureEntry = { name: 'user-auth', spec: 'pending', plan: 'not_found', category: null, tags: [], tier: 'standard' }
const auditLog: FeatureEntry = { name: 'audit-log', spec: 'pending', plan: 'not_found', category: null, tags: [], tier: 'standard' }
